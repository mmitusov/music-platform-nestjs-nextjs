...
Теперь когда мы добавили необходимый импорт и задали ему путь - мы можем отображать файлы указав их путь в поисковой строке браузера клиента. Например - http://localhost:3000/image/unique_name.jpg. Напомню, что путь "image/unique_name.jpg" мы генерируем и сохраняем в БД при создании файла.

Далее продолжим заниматься функционалом бека и займемся функцией которая будет увиличивать количество прослушиваний трека и сохранять эту инфу в БД.